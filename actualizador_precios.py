...
CATALOGO_PRECIOS = {
    ...
    "CAPCUT (Correo Genérico)": {
     ...
     "Youtube Premium (Correo Genérico)": {
        ...
        "3 meses": {"price": 15, "desc": "Youtube con todas sus funciones premium, nosotros entregamos el correo y la clave que vas a usar."},
    },
       "Crunchyroll (Plan Mega Fan)": {
        ...
        "3 meses": {"price": 12, "desc": "El plan Mega Fan es el plan más popular de Crunchyroll, que admite descargas y se puede ver hasta en dos dispositivos a la vez, nosotros entregamos el correo y la clave que vas a usar."},
